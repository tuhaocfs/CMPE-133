...
<body>
  <div class="topnav">
    ...
    "Thanks to your talks on efficiency, I think I’m becoming a better worker!",
    "Boss, can I ask you something? ",
    "What ever happened to Mr. Pearson? ",
    "",
    "You don’t have to be so callous about it. After all, Peter was our boss.",
    "",
    "But isn’t it weird that we never heard from him right before the company said you were promoted?",
    "And when we did, it was from the news saying that he was found in the river nearby the office?",
    "I heard from the other workers that there’s something fishy about it. Like some sort of conspiracy.",
    "",
    "Right, of course.",
    "I do have to say, I kinda like you better than Mr. Pearson. You’re nicer.",
    "",
    "Roger that!",
    "end"];
    var playerScriptA = [
    "Pat, your nerves almost got the best out of you in the last meeting. ",
    "What about Peter?",
    "Was. He thought he held all the power. But he was wrong.",
    "Pat, spreading rumors is a waste of time. Get back to work.",
    "Only because I know how to use it. Get me that report ASAP. ",
    "The End"];
    var part = 0;
    var stage = 0;
    var n = 100;
